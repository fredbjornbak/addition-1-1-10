...
const PlaceValueNumberArea: React.FC<PlaceValueNumberAreaProps> = ({
  ...
  return (
    <div 
      className="p-6 rounded-[50px] border-4 min-h-[280px] cursor-pointer transition-all duration-300"
    ...
    >
      <div className="grid grid-cols-2 gap-8 h-full">
        ...
        <div className="relative">
          ...
          <div className="relative h-48 border-2 border-dashed border-gray-300 rounded-lg bg-blue-25">
          ...
          <div className="text-lg text-center mt-3 font-dm-sans text-grade-black font-bold">
            {tensCount}
          </div>
        </div>
        ...
        <div className="relative">
          ...
          <div 
            className={`relative h-48 border-2 border-dashed border-gray-300 rounded-lg bg-orange-25 transition-all duration-300 ${
      ...
      <div className="text-center mt-6 font-dm-sans text-grade-body text-grade-black">
        <div className="text-xl font-bold">{currentTotal} / {number}</div>
        <div className="text-sm text-gray-500 mt-2">Click to add blocks</div>
      </div>
